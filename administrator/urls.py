...
urlpatterns = [
    ...
    path('voters/approve/<str:voter_id>/<str:admin_id>', views.approveVoter, name="approveVoter"),
    path('voters/disapprove/<str:voter_id>/<str:admin_id>', views.disapproveVoter, name="disapproveVoter"),
